...
Outside of work, I spend my time kayaking and visiting art museums — both ways to slow down, observe more closely, and see familiar things from a new angle 🛶🖼️
      ...
      <h1>Get in touch</h1>
      <p>
        I am on <a href="https://www.linkedin.com/in/lea-beiermann/">LinkedIn</a> and <a href="https://techhub.social/@lea_bei">Mastodon</a>. You can also send me an email via <a href="mailto:lea@beiermann.de">lea@beiermann.de</a>
      </p>
      ...
      <p>
        <i>Pssst! Click the button in the top right corner to turn this website 
	into your personal canvas! This playful website was designed by <a href="https://github.com/OrionReed/orionreed.com">Orion Reed</a>.</i>
      </p>
